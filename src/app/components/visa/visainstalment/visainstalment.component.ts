...
import { VisaInstalmentRequest, VisaInstalmentResponse } from '../visamodel/visainsalment';
import Swal from 'sweetalert2';
declare var $: any;

@Component({
  selector: 'app-visainstalment',
  templateUrl: './visainstalment.component.html',
  styleUrls: ['./visainstalment.component.css']
})
export class VisainstalmentComponent implements OnInit {
